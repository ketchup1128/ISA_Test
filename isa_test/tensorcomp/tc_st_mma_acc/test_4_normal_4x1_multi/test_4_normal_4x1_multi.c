...
void test_1_normal_mode_4x1(void) {
    ...
    uint32_t rs2_config_0 = MAKE_RS2(0, 0, 0);  // startpoints all at 0
    uint32_t rs2_config_1 = MAKE_RS2(4, 1, 0);  // startpoints all at 0
    uint32_t rs2_config_2 = MAKE_RS2(0, 2, 0);  // startpoints all at 0
    uint32_t rs2_config_3 = MAKE_RS2(4, 3, 0);  // startpoints all at 0
    ...
    PRINT("Test 4x1 multi completed\n");
}

...
void test_3_sparse_mode(void) {
    ...
    uint32_t rs2_config_spa_0 = MAKE_RS2(0, 0, 4);  // spa_start at block 4
    uint32_t rs2_config_spa_1 = MAKE_RS2(8, 6, 5);  // spa_start at block 4
    uint32_t rs2_config_spa_2 = MAKE_RS2(0, 10, 14);  // spa_start at block 4
    ...
    TC_ST_MMA_ACC(acc_addr, 0, 5, rs2_config_spa_0);
    PRINT("rs2_config: 0x%08X (spa_start=4)\n", rs2_config_spa_1);
    TC_ST_MMA_ACC(acc_addr, 0, 5, rs2_config_spa_1);

    PRINT("Loading trs1_data (0x%08X) into tr0\n", addr_trs1);
    T_LD(0, 0, addr_trs1);
    TC_ST_MMA_ACC(acc_addr, 0, 5, rs2_config_spa_2);

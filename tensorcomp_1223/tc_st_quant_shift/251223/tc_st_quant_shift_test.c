...
#include <stdint.h>
 ...
 void test_1_quant_right_shift(void) {
     ...
     TC_ST_QUANT_SHIFT(acc_addr, shift_config);
 ...
 void test_2_quant_left_shift(void) {
 ...
 int main(void) {
     ...
     test_1_quant_right_shift();
     test_2_quant_left_shift();

 ...
 */
 ...
 void test_1_quant_acc_4x1_left_data(void) {
    ...
    int32_t rs2_config = MAKE_INIT_RS2(0, 4, 0, 0);
    int32_t rs2_config_acc = MAKE_INIT_RS2(4, 4, 0, 0);
     
     // Execute tc.st.init to initialize the acc_buffer
     TC_ST_INIT(acc_addr, 0, rs2_config);
     TC_QUANT(acc_addr, 1, rs2_config);
     TC_QUANT_ACC(acc_addr, 1, rs2_config_acc);
 ...
 void test_2_quant_acc_4x1_top_data(void) {
    ...
    int32_t rs2_config = MAKE_INIT_RS2(0, 0, 0, 1);
    int32_t rs2_config_acc = MAKE_INIT_RS2(0, 0, 1, 1);
 ...
 void test_3_quant_acc_2x2_left_data(void) {
    ...
    int32_t rs2_config = MAKE_INIT_RS2(0, 2, 0, 0);
    int32_t rs2_config_acc = MAKE_INIT_RS2(2, 2, 0, 0);
 ...
 void test_4_quant_acc_2x2_top_data(void) {
    ...
    int32_t rs2_config = MAKE_INIT_RS2(0, 0, 0, 2);
    int32_t rs2_config_acc = MAKE_INIT_RS2(0, 0, 2, 2);
 ...
 int main(void) {
     ...
     test_1_quant_acc_4x1_left_data();
     test_2_quant_acc_4x1_top_data();
     test_3_quant_acc_2x2_left_data();
     test_4_quant_acc_2x2_top_data();
